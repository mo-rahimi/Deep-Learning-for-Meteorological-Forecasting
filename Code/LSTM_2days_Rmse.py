...
def create_lstm_model(input_shape, num_outputs):
    ...
    # Model compilation
    model.compile(optimizer='adam', loss='mse', metrics=[root_mean_squared_error, 'mae'])
    return model
...
model.save("lstm_2days_prediction_try3.h5")

import pickle
with open("history_2days_try3.pkl", "wb") as file:
